/* This file is NOT part of tpllib, but is used by tpllib on the systems
   ...
   The first part of this comment used to have Wget instead of tpllib,
   which means that I must have stolen it from a Wget dev web page.
 */
